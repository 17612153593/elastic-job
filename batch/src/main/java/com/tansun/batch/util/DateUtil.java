...
public class DateUtil extends DateUtils {
     ...
     */
//    public static Date concat(Date ymd, String hm) {
...
//                Date date = DateUtil
//                        .convert(dateString, DateUtil.DATE_TIME_FORMAT);
//                return date;
...
//    }
    ...
    public static String addDay(Date date, int day) {
        ...
        return simpleDateFormat.format(new Date(date.getTime() + DateUtils.MILLIS_PER_DAY * day));
    }
